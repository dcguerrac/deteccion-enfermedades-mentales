...
<center>
    <form name="form">
        ...
        <table id="cuadro" align="center">
            ...
            <tr>
                ...
                <td>
                    <div align="center"><input name="txtUsuario" type="text" class="input_text_combo" size="15"
                                               color="white" onKeyDown="return pulsar(event,this)" maxlength="10"></div>
                </td>
            </tr>
            <tr>
                <td class="tituloFormulario">
                    <div align="left"><a>Contraseña:</a></div>
                </td>
                <td>
            ...
            <tr>
                <td align="center"><a href="javascript:enviar('<%=request.getContextPath()%>')"> <img
