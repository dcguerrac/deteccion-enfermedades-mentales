...
<html>
    <head>       
        <title>Modificar Mantenimiento de Sexo!!!!</title>
    ...
    <body style="background-color: #F0ECEA;" >        
     ...
     <table width="50%" border="0"  class="FondoTabla">
       <tr>
         <td colspan="2" class="tituloTabla" ><div align="center">Actualizar   Sexo </div></td>
       </tr>
       <tr>
         <td width="35%" class="tituloFormulario"><div align="left">Nombre Sexo :</div></td>
