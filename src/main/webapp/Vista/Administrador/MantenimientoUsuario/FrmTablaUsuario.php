        ...
        <form name="form">
            ...
            <div id="estructura">  
                ...
                <div id="contenido" style="height: 467px;width: 100%">
                    <br><br> 
                  <div>
                      <input type="submit" style="float: right" value="Insertar Nuevo Usuario " onclick="NuevoUsuario()">
                      <br><br><br><br>
                      <center>
                      <table border="1" class="container-table">
                          <tr >
                            <td class="titulo" colspan="10"><center><b>Tabla De Usuarios</b></center></td>
                        ...
                        <tr align="center">
                            ...
                            <td class="titulo2"><center><a href="javascript:eliminarUsuario('<?php echo $reg['CodPer']; ?>')"><img src="../../../Imagenes/eliminar.png" alt="" width="20" height="20"/></a></center></td>  
                            <td class="titulo2"><center><a href="javascript:editartbusuario('<?php echo $reg['CodPer']; ?>')"><img src="../../../Imagenes/editar.png" alt="" width="20" height="20"/></a></center></td>  
                        </tr>
                        <?php  }   ?>
                    </table>
                    </center>
