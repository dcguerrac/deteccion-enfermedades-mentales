...
<html>
    <head>
        <meta charset="UTF-8">
        <title>EDITAR TABLA ADMINISTRADORES</title>
        ...
        <form name="form">
            ...
            <div id="estructura">  
                ...
                <div id="contenido" style="height:600px;width: 100%">
                    <br>
                    <a href="javascript:RegresarAdministrador()"><img src="../../../Imagenes/regresar.png" width="70"/></a>
                    <br>
                    <div>
                      <center>
                      <table border="0" class="container-table">
                        <tr>
                            <td  class="titulo" colspan="2"><center><b>Tabla De Administradores</b></center></td>
                        </tr>
                        ...
                        <tr>    
                            <td><input type="submit" colspan="3" value="Actualizar" onclick="ActualizarAdministrador()"></td>
                        </tr>
                        <?php  }   ?>
                      </table>
                      </center>
