            ...
            <div id="estructura">  
                ...
                <div id="contenido" style="height: 650px;width: 100%">
                    <div id="container">
                        ...
                        <div id="fin">
                            <br><br>
                            <center><input type="submit" value="  Crear  Cuenta  " onclick="CrearAdministrador()"></center>
                            <br>
                            <center><a href="javascript:MenuAdministrador('../../../Controlador/',9)">          Regresar a visualizar la tabla</a></center>
                        </div>
                    </div>
                </div>
                <div id="pie">
